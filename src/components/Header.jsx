        ...
        <div className="flex items-center pt-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          {user && myprofile ? (
            ...
            <>
              ...
              <Link
                to="login/"
                className="text-white bg-gray-800 hover:text-xl focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
              >
                Sign In
              </Link>
            </>
