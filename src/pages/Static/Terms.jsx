    ...
    <div className="text-dark">
      ...
      <main className="dark:text-white">
        ...
        <section className="flex-col  w-[90%] h-[20vh] mx-auto shadow-md ">
          <h2 className="flex mx-auto text-2xl text-red-600 font-mono">Information We Collect</h2>
          <p>
            We may collect personal information such as your name, email
            address, and phone number when you fill out a contact form or
            subscribe to our newsletter. We use this information to communicate
            with you and provide the services you requested.
          </p>
        </section>
        <section  className="flex-col  w-[90%] h-[20vh] mx-auto shadow-md ">
          <h2  className="flex mx-auto text-2xl  text-red-600 font-mono ">How We Use Your Information</h2>
          <p>
        ...
        <section className="flex-col w-[90%]  mx-auto shadow-md h-[20vh]">
          <h2 className="flex mx-auto text-2xl font-mono text-rose-600 ">Security</h2>
          <p>
            We take reasonable measures to protect your personal information
            from unauthorized access or disclosure. However, please note that no
            method of transmission over the internet or electronic storage is
            100% secure.
          </p>
        </section>
        <section className="flex-col w-[90%] h-[20vh] shadow-md mx-auto font-mono  ">
          <h2 className="flex mx-auto text-2xl font-mono text-red-600 ">Third-Party Links</h2>
          <p>
        ...
        <section className="flex-col w-[90%] h-[20vh] shadow-md mx-auto font-mono  ">
          <h2 className="flex font-mono text-2xl text-red-600">Changes to This Policy</h2>
          <p>
            We may update this privacy policy from time to time. Any changes
            will be posted on this page, and the date at the top will indicate
            the latest revision. We encourage you to review this policy
            periodically.
          </p>
        </section>
      </main>
      <footer className="flex mx-auto justify-center">
        <p className="text-xl dark:text-white">&copy; 2024 UniGram. All rights reserved.</p>
      </footer>
    </div>
  );
};
