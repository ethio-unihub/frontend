    ...
    <div>
      ...
      <div className="md:ml-[280px] mx-8 ">
        ...
        <main className="flex-col font-mono dark:text-white">
          ...
          <p className="flex mx-auto justify-center mt-10">
            Team Alpha Students at Addis Ababa Sciense And Technology University{" "}
            <span className="text-yellow-600"> GDSC AASTU </span>
          </p>
        </main>
        <section>
          <div className="flex mx-auto justify-center dark:text-white mt-[10vh] rounded-lg overflow-hidden">
          ...
          <div className="flex mx-auto justify-center dark:text-white h-[10vh]">
            <div className="flex flex-col w-[30vh]">
              <h1>Samual Keleb</h1>
              <img src="" alt="" />
              <p>Front End Dev</p>
          ...
          <div className="flex mx-auto justify-center dark:text-white">
            <div className="flex flex-col w-[30vh]">
